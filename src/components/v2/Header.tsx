            ...
            <header className="w-full max-w-7xl bg-white/95 backdrop-blur-lg md:shadow-[0_8px_30px_rgb(0,0,0,0.08)] md:rounded-full px-5 py-3 lg:px-8 lg:py-4 flex justify-between items-center text-[#0A1A3A] border-b md:border border-gray-100">
                ...
                <nav className="hidden md:flex items-center gap-3 lg:gap-8 text-[11px] lg:text-sm font-bold tracking-wider lg:tracking-widest uppercase text-gray-500 relative flex-1 justify-center whitespace-nowrap">
                    ...
                    <div className="group cursor-pointer">
                        ...
                        {/* Invishield invisible hover bridge */}
                        <div className="absolute top-full left-0 w-full h-6 bg-transparent"></div>

                        {/* Mega Menu Dropdown */}
                        <div className="absolute top-[calc(100%+12px)] left-0 md:-left-12 lg:left-1/2 lg:-translate-x-1/2 w-[calc(100vw-48px)] max-w-[450px] bg-white border border-gray-100 shadow-[0_20px_60px_rgba(0,0,0,0.1)] rounded-3xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 overflow-hidden transform group-hover:translate-y-0 translate-y-2 pointer-events-none group-hover:pointer-events-auto">
                    ...
                    <div className="group cursor-pointer">
                        ...
                        {/* Mega Menu Dropdown */}
                        <div className="absolute top-[calc(100%+12px)] right-0 w-[calc(100vw-48px)] max-w-[450px] bg-white border border-gray-100 shadow-[0_20px_60px_rgba(0,0,0,0.1)] rounded-3xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 overflow-hidden transform group-hover:translate-y-0 translate-y-2 pointer-events-none group-hover:pointer-events-auto">
