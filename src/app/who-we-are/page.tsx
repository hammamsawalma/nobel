        ...
        <div className="bg-white text-gray-900 font-sans selection:bg-[#0A1A3A] selection:text-white overflow-x-hidden min-h-screen">
            ...
            <section className="py-24 bg-[#0A1A3A]">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div initial={{ x: 50, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={snapSpring as any}>
                        <h2 className="text-4xl font-black text-white mb-6">Our Directive.</h2>
                        ...
                        <p className="text-white text-lg leading-relaxed font-bold border-l-[6px] border-blue-500 pl-6">
            ...
            <section className="py-24 bg-white border-y border-gray-100">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <h2 className="text-5xl font-black text-[#0A1A3A] mb-16 text-center">Core Virtues.</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                        {[
                            ...
                            <motion.div key={i} initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ ...snapSpring, delay: i * 0.1 } as any} className="bg-gray-50 p-10 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:border-blue-200 transition-all">
                                <div className="text-white font-mono mb-6 text-xl font-bold bg-[#0A1A3A] w-12 h-12 flex items-center justify-center rounded-xl shadow-md">0{i + 1}</div>
                                <h3 className="text-3xl font-black text-[#0A1A3A] mb-4">{virtue.title}</h3>
                                <p className="text-gray-600 leading-relaxed font-medium">{virtue.desc}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
            ...
            {/* TEAM / LEADERSHIP */}
            <section className="py-32 bg-[#0A1A3A] overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 lg:px-12">
                    <motion.div
                    ...
                    >
                        <h2 className="text-5xl font-black text-white mb-6">Strategic Node.</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {[
                            ...
                            >
                                ...
                                <h3 className="text-2xl font-black text-white mb-1 group-hover:text-blue-400 transition-colors">{member.name}</h3>
