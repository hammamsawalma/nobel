...
export default function StrategicEquitiesPage() {
    return (
                    ...
                    <div className="lg:col-span-8">
                        <CinematicReveal direction="up" duration={1.5}>
                            <div className="flex items-center gap-6 mb-8">
                                <span className="text-transparent bg-clip-text bg-gradient-gold-foil font-display text-2xl lg:text-3xl">II</span>
                            ...
                            <h1 className="text-4xl md:text-6xl lg:text-[5rem] font-display text-noble-ivory leading-[1.1] mb-8">
                                Strategic <br /><span className="italic text-transparent bg-clip-text bg-gradient-gold-foil">Equities.</span>
                            </h1>
                        </CinematicReveal>
                    </div>
                    ...
                    <div className="lg:col-span-4 lg:pt-24 border-t lg:border-t-0 lg:border-l border-noble-gold-900/30 pt-8 lg:pl-8">
                        <CinematicReveal delay={0.3}>
                            <p className="text-noble-slate font-serif text-sm tracking-wide leading-loose">
                                We do not speculate; we acquire ownership in global monopolies. Directed exposure to mega-cap blue-chip equities structured to weather macroeconomic cycles.
                            </p>
                        </CinematicReveal>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <CinematicReveal delay={0.1}>
                        <div className="border border-noble-gold-900/20 p-8 h-full bg-noble-charcoal/20 hover:bg-noble-gold-900/10 transition-colors duration-700">
                            <h3 className="text-noble-gold-400 font-serif italic text-2xl mb-4">Structural Moats</h3>
                            <p className="text-noble-slate text-xs font-sans tracking-widest leading-loose">
                                Focused allocation towards enterprises exhibiting impenetrable pricing power, dominant market share, and formidable barriers to entry.
                            </p>
                        </div>
                    </CinematicReveal>
                    ...
                    <CinematicReveal delay={0.2}>
                        <div className="border border-noble-gold-900/20 p-8 h-full bg-noble-charcoal/20 hover:bg-noble-gold-900/10 transition-colors duration-700">
                            <h3 className="text-noble-gold-400 font-serif italic text-2xl mb-4">Dividend Compounding</h3>
                            <p className="text-noble-slate text-xs font-sans tracking-widest leading-loose">
                                Prioritizing organizations with decades-long histories of returning capital via relentlessly growing, sustainable dividend distributions.
                            </p>
                        </div>
                    </CinematicReveal>
                    ...
                    <CinematicReveal delay={0.3}>
                        <div className="border border-noble-gold-900/20 p-8 h-full bg-noble-charcoal/20 hover:bg-noble-gold-900/10 transition-colors duration-700">
                            <h3 className="text-noble-gold-400 font-serif italic text-2xl mb-4">Systematic Hedging</h3>
                            <p className="text-noble-slate text-xs font-sans tracking-widest leading-loose">
                                Engineering asymmetric payoff profiles via derivatives to blunt downside tail-risk during periods of acute market dislocation.
                            </p>
                        </div>
                    </CinematicReveal>
            ...
            <section className="px-6 lg:px-12 max-w-4xl mx-auto text-center mb-32">
                <CinematicReveal>
                    ...
                    <h2 className="text-3xl md:text-4xl font-display italic text-noble-ivory leading-relaxed mb-8">
                        "Price is what you pay; value is what you architect. We own the economic engines of the future."
                    </h2>
